  ...
  return `
    <div class="event-card">
      <div class="event-image-container">
        <a href="#" class="event-image-link">
          <img src="${event.image}" alt="${event.title}" class="event-image">
        </a>
      </div>
      <div class="event-content">
        <div class="event-date">${formatEventDate(event.date)} UTC</div>
        <a href="#" class="event-title-link">
        ...
        ${event.attendees ? `<div class="event-attendees">${event.attendees} attendees</div>` : ""}
      </div>
    </div>
  `;
};
...
const filterEvents = () => {
  ...
  const filtered = eventsStore.filter(event => {
    ...
    if (distance !== "any" && event.distance > parseInt(distance)) return false;
...
["type-filter", "distance-filter", "category-filter"].forEach(id => {
